...
<center><img src="tutorials/board.jpg" alt="Overview of the game board" style="width: 400px;"/></center>
...
<center><img src="tutorials/validNetwork1.jpg" alt="A winning configurations for black chip" style="width: 300px;"/> 
<img src="tutorials/validNetwork2.jpg" alt="A winning configurations for black chip" style="width: 300px;"/></center>
...
<center><img src="tutorials/breakConnection.jpg" alt="Wrong network example #1" style="width: 300px;"/></center>

  - A "network" can have only two chips in the goal areas: the first and last chips in the "network".

<center><img src="tutorials/wrongNetwork1.jpg" alt="Wrong network example #2" style="width: 300px;"/></center>

  - A "network" cannot pass through the same chip twice, even if it is only counted once.

<center><img src="tutorials/wrongNetwork2.jpg" alt="Wrong network example #3" style="width: 300px;"/></center>

  - A "network" cannot pass through a chip without turning a corner.

<center><img src="tutorials/wrongNetwork3.jpg" alt="Wrong network example #4" style="width: 300px;"/></center>
...
<center><img src="tutorials/validMove.jpg" alt="Connected group example" style="width: 300px;"/></center>
